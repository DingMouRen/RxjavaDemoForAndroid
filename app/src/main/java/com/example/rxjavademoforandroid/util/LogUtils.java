package com.example.rxjavademoforandroid.util;
...
import com.example.rxjavademoforandroid.MyApplication;
...
public final class LogUtils {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = MyApplication.sContext
                    .getPackageManager()
                    .getPackageInfo(MyApplication.sContext.getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && MyApplication.sContext.getExternalCacheDir() != null)
                sDefaultDir = MyApplication.sContext.getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                sDefaultDir = MyApplication.sContext.getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
